...
struct Home: View {
    ...
    var body: some View {
                ...
                VStack(spacing: 15){
                    ...
                    Button{
                        if pomodoroModel.isStarted{
                            ...
                            // MARK: Cancelling ALl Notifcations
        ...
        .alert("Session finished", isPresented: $pomodoroModel.isFinished){
                ...
                Text("\(pomodoroModel.minutes) min")
                    ...
                    .contextMenu{
                        ContextMenuOptions(maxValue: 60, hint: "min"){
                            value in pomodoroModel.minutes = value
                        }
                    }
